...
public class MobileExceptionHandler {
    ...
    public ResponseEntity<String> manejarErrorBackend(WebClientResponseException exception) {
        // Si el backend responde con un error funcional, lo traslado sin disfrazarlo como un 500 genérico.
    ...
    public ResponseEntity<ProblemDetail> manejarRateLimit(RequestNotPermitted exception) {

        ProblemDetail problem = ProblemDetail.forStatusAndDetail(
                HttpStatus.TOO_MANY_REQUESTS,
                "El canal superó temporalmente el límite de solicitudes permitido."
        );
        problem.setTitle("Límite de solicitudes excedido");
