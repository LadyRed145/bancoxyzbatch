...
public class EstadoCuentaAnualWriter
    ...
    /*
     Permite coordinar el acceso concurrente a una combinación
     cuenta + año cuando diferentes chunks son procesados
     simultáneamente.
     */
    private final ConcurrentMap<CuentaAnioKey, Object> locks =
    ...
    public void write(
        ...
        /*
         Agrupamos primero los movimientos del chunk por cuenta + año.
         */
        ...
        for (MovimientoAnual movimiento : chunk) {
            ...
            /*
             Cada combinación cuenta + año tiene su propio
             bloqueo. De esta forma, cuentas diferentes pueden
             continuar procesándose en paralelo.
             */
            Object lock =
